	...
	public partial class MainForm : Form
	{
		...
		private void btnAdd_Click(object sender, EventArgs e)
		{
			...
			if (!ValidateChildren())
			{
				...
				MessageBox.Show("The form contains errors. Please check the input data",
					"ERROR: 404",
			...
			{
				//Expected exception
				MessageBox.Show(string.Format("The birth date {0}.{1}.{2} is invalid", ex.BirthDate.Year, ex.BirthDate.Month, ex.BirthDate.Day));
			}
			catch (Exception)
			{
